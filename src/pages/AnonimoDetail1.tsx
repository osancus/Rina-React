...
import "./AnonimoDetail1.css";
import Dropdown from '../components/Dropdown'

const AnonimoDetail1: FunctionComponent = () => {
    ...
    return (
        <div className="verifier-anonimo-detail1">
            <div className="layoutsection-title1">
                ...
                <div className="tag13">
                    <div className="lorem-ipsum13">Footprint neutralised</div>
                </div>
                                                ...
                                                <div className="list8">
                                                    <div className="master-utilities40">
                                                        <div className="txtleft-icon40">
                                                            <img
                                                                className="placeholder-exagon78"
                                                                alt=""
                                        ...
                                        <div className="container10">
                                            <div className="navigation-chevron-expand4">
                                                <div className="master2">
                                                    ...
                                                    <img
                                                        className="focus-outline-icon2"
                                                        alt=""
                                                        src="/focus-outline.svg"
                                                    />
                                                    <img
                                                        className="user-presence-icon2"
                                                        alt=""
                                                ...
                                                <div className="list-25">
                                                    <div className="list9">
                                                        ...
                                                        <div className="master-utilities55">
                                                            <div className="txtleft-icon40">
                                                                <img
                                                                    className="navigation-chevron-expand4"
                                                                    alt=""
                ...
                <div className="logo-menu2">
                    ...
                    <div className="men2">
                        <div className="layoutmenu-voicesdesktop22">
                            <div className="voice12" onClick={() => navigate('/')}>Homepage</div>
            ...
            <div className="verification-date-group">
                ...
                <div className="title25">00/00/0000</div>
                <div className="title26">Carbon status</div>
                <div className="total-co2e-group">
                    <div className="total-co2e1">Total CO2e</div>
                    <div className="title27">25 Kg</div>
                </div>
            ...
            <div className="product-id-l10494000004" style={{ left: 30 }}><b>{`Product ID L1049400000 `}</b></div>
            <div className="at-vero-eos1">
                At vero eos et accusamus et iusto odio dignissimos ducimus qui
                blanditiis praesentium voluptatum deleniti atque corrupti quos dolores
                et quas molestias...
            </div>
            <div className="label66">Read full description</div>
            <div className="title28">Still mill s.p.a</div>
            <div className="ddt-number1">DDT number</div>
            <div className="seller1">Seller</div>
            <div className="title29">180 kg</div>
            <div className="weight">Weight</div>
            <div className="title30">000000</div>
            <div className="dtt-date1">DTT date</div>
            <div className="title31">00/00/00</div>
            <div className="delivered-data13">Delivered data</div>
            <div className="title32">00/00/00</div>
            ...
            <div className="verification-number-group">
                ...
                <div className="label67">10303030</div>
            </div>
            ...
            <div className="dropzone1">
                <div className="content1" style={{ width: "500px" }}>
                    ...
                    <div className="drop-files-here1" style={{ width: "500px" }}>
            ...
            <div className="primary-filled-mini-text-o1">
                ...
                <div className="master-button1" onClick={toggle}>
                    <img
                        className="document-iconstext-style2"
                        alt=""
                        src="/document-iconstextstyle1.svg"
                    />
                    <div className="label-text1">Check certificate</div>
                    <img
                        className="document-iconstext-style2"
                        alt=""
                        src="/document-iconstextstyle2.svg"
                    />
                </div>
            </div>
        </div>
